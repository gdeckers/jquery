...
function atualizarPlacar(){
    if(vez == 'o'){
        $('.placar img').attr('src', 'assets/images/circle.png');
    } else {
        $('.placar img').attr('src', 'assets/images/close.png');
    }
}
...
$(function(){
    ...
    $('.area').bind('click', function(){
        if($(this).find('img').length == 0) {
            ...
            if(vez == 'o'){
                $(this).html('<img src="assets/images/circle.png" border="0" height="50" />');
                $(this).attr('data-marcado','o');
                vez = 'x';
            } else {
                $(this).html('<img src="assets/images/close.png" border="0" height="50" />');
